...
;; data
(defface t2t-date-face '((t (:foreground "yellow" :background "white"))) 
  "Txt2Tags Date."  :group 'txt2tags-faces)

;; conf area
(defface t2t-config-face '((t (:foreground "yellow" :background "white"))) 
  "Txt2Tags Config Area."  :group 'txt2tags-faces)

;; conf area
(defface t2t-postproc-face '((t (:foreground "medium spring green" :background "white"))) 
  "Txt2Tags PostProc Area."  :group 'txt2tags-faces)


;; Verbatim
(defface t2t-verbatim-face '((t (:foreground "SpringGreen1" :background "white"))) 
  "Txt2Tags Verbatim."  :group 'txt2tags-faces)

;; http + e-mails

(defface t2t-internet-face '((t (:foreground "dark orchid" :background "white"))) 
  "Txt2Tags E-mail and Http." :group 'txt2tags-faces)

;; números

(defface t2t-numbers-face '((t (:foreground "plum1" :background "white"))) 
  "Txt2Tags Numbers." :group 'txt2tags-faces)

;; títulos de seções
(defface t2t-sections-face-5 '((t (:foreground "cyan" :background "white"))) 
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-4 '((t (:foreground "cyan" :background "white"))) 
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-3 '((t (:foreground "cyan" :background "white"))) 
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-2 '((t (:foreground "cyan" :background "white"))) 
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-1 '((t (:foreground "cyan" :background "white"))) 
  "Txt2Tags Section Titles." :group 'txt2tags-faces)


;; Comentários yellow4
(defface t2t-comments-face '((t (:foreground "yellow" :background "white"))) 
  "Txt2Tags Date." :group 'txt2tags-faces)

;; listas
(defface t2t-lists-face '((t (:foreground "dodger blue" :background "white"))) 
  "Txt2Tags Lists." :group 'txt2tags-faces)

;; quote
(defface t2t-quote-face '((t (:foreground "white" :background "yellow3"))) 
  "Txt2Tags Quote." :group 'txt2tags-faces)

;; raw
(defface t2t-raw-face '((t (:foreground "spring green" :background "white"))) 
  "Txt2Tags Raw." :group 'txt2tags-faces)

;; region
(defface t2t-region-face '((t (:foreground "green" :background "white"))) 
  "Txt2Tags Region." :group 'txt2tags-faces)

;; imagens
(defface t2t-images-face '((t (:foreground "SlateBlue4" :background "white"))) 
  "Txt2Tags Images." :group 'txt2tags-faces)

;; negrito
(defface t2t-bold-face '((t (:width extra-expanded :weight extra-bold :foreground "midnight blue" :background "white"))) 
  "Txt2Tags Bold." :group 'txt2tags-faces)

;; itálico
(defface t2t-italic-face '((t (:slant italic :foreground "SlateBlue2" :background "white"))) 
  "Txt2Tags Italic." :group 'txt2tags-faces)


;; negrito + itálico
(defface t2t-bold-italic-face '((t (:width extra-expanded :weight extra-bold :slant italic
			    :underline nil :foreground "medium slate blue" :background "white"))) 
  "Txt2Tags Bold Italic." :group 'txt2tags-faces)


;; tabelas
(defface t2t-tables-face '((t (:foreground "turquoise4" :background "white" :bold t))) 
  "Txt2Tags Tables." :group 'txt2tags-faces)


;; sublinhado
(defface t2t-underline-face '((t (:underline t :foreground "SlateBlue2" :background "white"))) 
  "Txt2Tags Underline." :group 'txt2tags-faces)

;; linha
(defface t2t-line-face '((t (:bold t :foreground "Blue2" :background "white"))) 
  "Txt2Tags line face." :group 'txt2tags-faces)

;; Fonte para mostrar o final de linha em branco em vermelho

(defface t2t-trailing-whitespace '((t (:bold t :foreground "Red" :background "white"))) 
  "Txt2Tags line face." :group 'txt2tags-faces)
